  ...
  const fetchData = async () => {
    try {
      const [projectsRes, messagesRes, earningsRes, hoursRes] =
        await Promise.all([
          axios.get("/api/service-providers/dashboard/projects", {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          }),
          axios.get("/api/service-providers/dashboard/messages", {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          }),
          axios.get("/api/service-providers/dashboard/earnings", {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          }),
          axios.get("/api/service-providers/dashboard/hours-worked", {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          }),
        ...
        <>
          <Row className="mb-4">
            ...
            <Col md={3}>
              <Card className="text-center p-3">
                <Card.Body>
                  <Card.Title>Finished Deadlines</Card.Title>
                  <Card.Text className="display-4">
            ...
            <Col md={3}>
              <Card className="text-center p-3">
                <Card.Body>
                  ...
                  <Card.Text className="display-4">{totalHours}</Card.Text>
                  <Button
                    variant="info"
                    as={Link}
